<?php namespace Laragun;
use Laragun\Mailgun\Mailgun\Lists;
use Laragun\Mailgun\Mailgun\MailgunApi;
use Config;
use Closure;
use Illuminate\View\Factory;
use Laragun\Mailgun\Mailgun\Message;
class Mailgun extends MailgunApi
{
	 ...
	 *
	 * @var \Laragun\Mailgun\Mailgun\Message
	 */
	protected $message;
	/**
     ...
     *
     * @var \Laragun\Mailgun\Mailgun\Lists
     */
    protected $lists;
	/**
	 ...
	 *
	 * @return \Laragun\Mailgun\Mailgun
	 */
     ...
     * Access mailinglists
     *
     * @return \Laragun\Mailgun\Mailgun\Lists
     */
	 ...
	 * @param  \Laragun\Mailgun\Mailgun\Message $message
	 * @return mixed
	 */
